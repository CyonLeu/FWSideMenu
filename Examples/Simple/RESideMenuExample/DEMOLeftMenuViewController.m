...
//            [navigationController pushViewController:[[DEMOFirstViewController alloc] init]  animated:NO];
...
//                                                         animated:YES];
            DEMOAppDelegate *appDelegate = (DEMOAppDelegate *)[[UIApplication sharedApplication] delegate];
            UINavigationController *navigationController = (UINavigationController *)appDelegate.navigationController;
            [navigationController pushViewController:[[DEMOSecondViewController alloc] init]  animated:NO];
            [self.sideMenuViewController setContentViewController:navigationController animated:YES ] ;
            [self.sideMenuViewController hideMenuViewController];
            break;
        }
